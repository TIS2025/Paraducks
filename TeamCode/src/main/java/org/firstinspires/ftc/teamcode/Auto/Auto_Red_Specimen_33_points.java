...
@Disabled
@Deprecated
@Autonomous(name = "Auto_Red_Specimen_33_points", group = "Autonomous")
public class Auto_Red_Specimen_33_points extends LinearOpMode {
...
//                .waitSeconds(0.2)
                .strafeToLinearHeading(new Vector2d(-52, 42), Math.toRadians(-90))
...
// ================================================= For third Sample
//                .strafeToLinearHeading(new Vector2d(-63, 40), Math.toRadians(-120))
//                .stopAndAdd(()-> new AutoSampleSpecimenIntake(outtake, elevator, 3))
//                .afterTime(0.6,()-> new AutoSampleSpecimenIntake(outtake))
//                .waitSeconds(1.9)
//                .stopAndAdd(()-> new AutoSampleSpecimenDrop(outtake, elevator, 1, 's'))
