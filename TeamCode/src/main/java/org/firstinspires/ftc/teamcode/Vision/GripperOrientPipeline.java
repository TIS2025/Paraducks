...
public class GripperOrientPipeline extends OpenCvPipeline {
    ...
    public Mat processFrame(Mat input) {
        ColorMask = preprocessFrame(input,ColorConstValues.lowRed,ColorConstValues.highRed);
        ...
        try{l_contourf = new MatOfPoint2f(l_contour.toArray());}
        catch (Exception e){
...
//        Imgproc.putText(input,text, new Point(10, 30), Imgproc.FONT_HERSHEY_COMPLEX, 1, new Scalar(0, 255, 0), 1);
    ...
    public void setAngle(MatOfPoint2f contour){
        try{
