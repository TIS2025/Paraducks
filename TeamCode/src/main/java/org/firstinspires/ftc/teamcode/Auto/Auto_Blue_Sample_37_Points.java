...
@Config
@Autonomous(name = "Auto_Blue_Sample_37_Points", group = "Autonomous")
public class Auto_Blue_Sample_37_Points extends LinearOpMode {
...
//        Pose2d initialPose = new Pose2d(-9, -60, Math.toRadians(90));
        ...
        Action trajectoryAction0 = drive.actionBuilder(drive.pose)
                ...
                .strafeToLinearHeading(new Vector2d(-9, -27), Math.toRadians(90))
                ...
                //TODO - Sample Picking
                .afterTime(0.4,()-> new AutoSampleIntake(outtake, elevator, 1))
                .strafeToLinearHeading(new Vector2d(-55, -42.5), Math.toRadians(90))
                .stopAndAdd(()-> new AutoSampleIntake(outtake))

                //TODO - Sale Outtake
                .strafeToLinearHeading(new Vector2d(-56, -51), Math.toRadians(45))
                .stopAndAdd(()-> new AutoSampleDrop(outtake, elevator))

                //TODO - Sample Picking
                .strafeToLinearHeading(new Vector2d(-63.5, -42), Math.toRadians(90))
                .stopAndAdd(()-> new AutoSampleIntake(outtake))


                //TODO - Sample Outtake
                .strafeToLinearHeading(new Vector2d(-57, -52), Math.toRadians(45))
                .stopAndAdd(()-> new AutoSampleDrop(outtake, elevator))
                .afterTime(0.4,()-> new AutoSampleIntake(outtake, elevator, 3))  // OverWriting
                .strafeToLinearHeading(new Vector2d(-59.5, -40), Math.toRadians(135))
                .stopAndAdd(()-> new AutoSampleIntake(outtake))
                ...
                .strafeToLinearHeading(new Vector2d(-30, -5), Math.toRadians(45))
