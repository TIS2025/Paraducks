...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks =  7710.279002154921; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -3376.7125026565914; // x position of the perpendicular encoder (in tick units)
    }
...
//        AngularVelocity angularVelocityDegrees = imu.getRobotAngularVelocity(AngleUnit.DEGREES); // change this getv external Heading velocity
...
//        Rotation2d heading = Rotation2d.exp(angles.getYaw(AngleUnit.RADIANS)); // get Extenral Heading
