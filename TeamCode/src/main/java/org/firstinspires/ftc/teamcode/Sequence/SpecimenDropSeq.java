...
public class SpecimenDropSeq {
    ...
    public SpecimenDropSeq(OuttakeSubsystem outtake, ElevatorSubsytem elevator) {
        Actions.runBlocking(
                new SequentialAction(
                        ...
                        new SleepAction(0.1),
                        new InstantAction(()-> new ShoulderCommand(outtake, OuttakeSubsystem.ShoulderState.AUTO_SPECIMEN_DROP)),
                        new InstantAction(()-> new ArmCommand(outtake, OuttakeSubsystem.ArmState.AUTO_SPECIMEN_DROP)),
    ...
    public static Action SpecimenDropSeqAction(OuttakeSubsystem outtake, ElevatorSubsytem elevator) {
